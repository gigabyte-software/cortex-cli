...
If you are asked to work on a user story task then you will follow the instructions below.
...
After completing those steps now implement the feature code following the approved plan.
